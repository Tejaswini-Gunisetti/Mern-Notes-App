  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}}>
      <div className="w-full max-w-md bg-gradient-to-br from-white to-purple-50 rounded-2xl shadow-2xl p-8 border border-purple-200 backdrop-blur-sm">
        <h2 className="text-3xl font-bold mb-8 text-center text-purple-800"> Create Account</h2>
        ...
        <p className="mt-6 text-center text-gray-600">
          ...
          <Link className="text-purple-600 hover:text-purple-700 font-semibold transition-colors" to="/login">
             Sign In
          </Link>
        </p>
      </div>
